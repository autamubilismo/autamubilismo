...
// Cottagecore Light Pattern
const lightPattern = {
  backgroundColor: '#F7F4D5',
  backgroundImage: `
    radial-gradient(at 0% 0%, rgba(211, 150, 140, 0.28) 0px, transparent 50%),
    radial-gradient(at 100% 0%, rgba(211, 150, 140, 0.12) 0px, transparent 50%),
    radial-gradient(at 50% 100%, rgba(211, 150, 140, 0.18) 0px, transparent 50%)
  `,
  ...
  return (
    <div
      className={`min-h-screen p-6 md:p-12 animate-in fade-in slide-in-from-bottom-6 duration-700 font-sans ${
        isLight
          ? 'selection:bg-[#D3968C] selection:text-[#0A3323]'
    ...
    >
      ...
      <div className="fixed inset-0 z-0 pointer-events-none overflow-hidden mix-blend-multiply">
        <div className={`absolute top-[-10%] left-[-5%] w-[600px] h-[600px] rounded-full blur-[120px] opacity-35 ${
          isLight ? 'bg-[#D3968C]' : 'bg-[#bd00ff]/30 animate-pulse'
        }`} />
        <div className={`absolute bottom-[-10%] right-[-5%] w-[500px] h-[500px] rounded-full blur-[100px] opacity-20 ${
          isLight ? 'bg-[#D3968C]' : 'bg-[#00fff2]/20 animate-pulse'
        }`} />
        {!isLight && (
