    ...
    <PageContainer theme={resolvedTheme}>
      ...
      {top3.length >= 3 && (
        <div className="flex justify-center items-end gap-2 md:gap-8 mb-16 px-4">
           <PodiumStep place={2} data={top3[0]} type={activeTab} theme={resolvedTheme} />
           <PodiumStep place={1} data={top3[1]} type={activeTab} theme={resolvedTheme} />
           <PodiumStep place={3} data={top3[2]} type={activeTab} theme={resolvedTheme} />
        </div>
      )}
