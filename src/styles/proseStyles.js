...
export const proseClass = (isLight) => `
  ...
  ${
    isLight
      ...
      : "prose-h2:border-l-4 prose-h2:border-[#fe88dd] prose-h2:pl-4"
  }
  ...
  ${
    isLight
      ...
      : "prose-a:text-[#00fff2] hover:prose-a:text-[#fe88dd]"
  }
  ...
  ${
    isLight
      ...
      : "prose-blockquote:bg-[#1e1e24] prose-blockquote:border-l-4 prose-blockquote:border-[#fe88dd] prose-blockquote:text-[#9CA3AF]"
  }
