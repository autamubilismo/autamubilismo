...
export const SITE_MAP = [
  ...
  { id: 'season', path: '/season', label: 'Temporada', desc: 'Tudo sobre a temporada 2026', icon: Trophy },
  ...
  { id: 'regulations', path: '/regulations', label: 'Regulamento', desc: 'Novo Regulamento de 2026', icon: BookOpen },
