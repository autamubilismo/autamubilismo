      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {MEDIA_DATA.map((item) => (
           ...
           >
              ...
              {/* Botão de Play */}
              <div className={`relative z-10 p-5 rounded-full transition-transform duration-300 group-hover:scale-125 ${isLight ? 'bg-white text-gray-900' : 'bg-[#caa5d8] text-white'}`}>
