    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <div className="mb-20">
        <div className="flex items-center gap-4 mb-8 border-b border-gray-200/10 pb-4">
           ...
           <span className={`px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest ${isLight ? 'bg-pink-100 text-pink-600' : 'bg-[#fe88dd]/20 text-[#fe88dd] border border-[#fe88dd]/30'}`}>
             Grid 2025
           </span>
        </div>
