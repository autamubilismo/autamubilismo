  ...
  if (!driver) {
    return (
      <div className={`min-h-screen flex flex-col items-center justify-center text-center p-6 ${isLight ? 'bg-[#FFF5F8]' : 'bg-[#050510]'}`}>
         ...
         <Link to="/drivers" className={`mt-6 px-8 py-3 rounded-full font-bold transition-all shadow-lg ${isLight ? 'bg-pink-500 text-white hover:bg-pink-600 shadow-pink-200' : 'bg-cyan-500 text-black hover:bg-cyan-400 shadow-cyan-500/50'}`}>Voltar ao Grid</Link>
      </div>
    );
  }
