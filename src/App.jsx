          ...
          <header className="flex justify-between items-center mb-12 pt-4 relative min-h-[100px]">
            <div className="flex-1 flex justify-start">
              <button 
                ...
                className={`group flex items-center gap-3 px-5 py-3 rounded-full transition-all ${
                  theme === 'light' 
                    ? 'bg-white text-gray-800 shadow-md' 
                    : 'bg-[#1a1a20] text-[#00fff2] border border-[#333]'
                }`}
              >
                <Menu size={24} /> 
            ...
            <div className="flex-1 flex justify-end gap-3">
              <button 
                ...
                className={`p-3 rounded-full flex items-center justify-center transition-colors ${
                  theme === 'light' 
                    ? 'bg-white shadow-sm text-gray-400 hover:text-gray-600' 
                    : 'bg-[#1a1a20] text-gray-500 border border-[#333] hover:text-[#00fff2]'
                }`}
              >
                <Search size={24} />
              </button>
              ...
              <button 
                ...
                className={`p-3 rounded-full transition-all ${
                  theme === 'light' 
                    ? 'bg-white shadow-lg text-yellow-500' 
                    : 'bg-[#1a1a20] text-[#00fff2] border border-[#333]'
                }`}
              >
